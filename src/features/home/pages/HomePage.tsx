  ...
  return (
    <div className="home-page">
      ...
      <div className="tier-section" id="plans">
        <TierCard title="Starter" subTitle="Benefits:" body="Lorem ipsum dolor sit amet..." />
        <TierCard title="Pro" subTitle="Benefits:" body="Lorem ipsum dolor sit amet..." />
        <TierCard title="Enterprise" subTitle="Benefits:" body="Lorem ipsum dolor sit amet..." />
      </div>
